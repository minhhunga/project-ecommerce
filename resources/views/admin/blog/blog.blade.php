                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->content }}</td>
                                                <td>
                                                    <a href="{{ url('admin/blog/update', $item->id) }}">Update</a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/blog/delete', $item->id) }}">Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <a href="{{ url('/admin/blog/create') }}" class="btn btn-primary">Create Blog</a>
                            </div>
                        </div>
                    </div>
                </div>
