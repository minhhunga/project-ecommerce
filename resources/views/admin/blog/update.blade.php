            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('blog.update', $blog->id) }}" method="POST" class="form-horizontal form-material" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group"> 
                                ...
                                <div class="col-md-12">
                                    <textarea name="content" class="form-control" value="{{ $blog->content }}" id="demo" rows="5"></textarea>
                                </div>
                            </div>
